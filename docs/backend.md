...
[**Node.js**](https://en.wikipedia.org/wiki/Node.js) is an open-source, cross-platform, JavaScript runtime for writing servers and command-line tools.

this page from: [sindresorhus](https://github.com/sponsors/sindresorhus)
:::
